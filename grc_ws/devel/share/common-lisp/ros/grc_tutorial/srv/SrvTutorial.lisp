...
(cl:in-package grc_tutorial-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grc_tutorial-srv:<SrvTutorial-request> is deprecated: use grc_tutorial-srv:SrvTutorial-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grc_tutorial-srv:a-val is deprecated.  Use grc_tutorial-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grc_tutorial-srv:b-val is deprecated.  Use grc_tutorial-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-request>)))
  ...
  "grc_tutorial/SrvTutorialRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-request)))
  "Returns string type for a service object of type 'SrvTutorial-request"
  "grc_tutorial/SrvTutorialRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grc_tutorial-srv:<SrvTutorial-response> is deprecated: use grc_tutorial-srv:SrvTutorial-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SrvTutorial-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grc_tutorial-srv:result-val is deprecated.  Use grc_tutorial-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-response>)))
  ...
  "grc_tutorial/SrvTutorialResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-response)))
  "Returns string type for a service object of type 'SrvTutorial-response"
  "grc_tutorial/SrvTutorialResponse")
