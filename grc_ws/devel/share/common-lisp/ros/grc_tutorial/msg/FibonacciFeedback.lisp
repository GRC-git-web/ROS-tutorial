...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grc_tutorial-msg:<FibonacciFeedback> is deprecated: use grc_tutorial-msg:FibonacciFeedback instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grc_tutorial-msg:sequence-val is deprecated.  Use grc_tutorial-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FibonacciFeedback>)))
  ...
  "grc_tutorial/FibonacciFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FibonacciFeedback)))
  "Returns string type for a message object of type 'FibonacciFeedback"
  "grc_tutorial/FibonacciFeedback")
